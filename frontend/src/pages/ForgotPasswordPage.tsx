    ...
    const handleSubmit = async (e: SubmitEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (err instanceof Error) {
                ...
                setError(errorWithResponse.response.data.message || "Something went wrong. Please try again.");
            } else {
        ...
        <div className="bg-slate-50 min-h-screen flex flex-col">
            ...
            <main className="flex-1 flex flex-col gap-5 items-center justify-center p-4 sm:p-6">
                ...
                <button
                    ...
                    className="flex items-center text-sm text-slate-500 hover:text-slate-900 hover:underline hover:cursor-pointer transition-all"
                >
                    Back to login
                    <ArrowRight />
                </button>
